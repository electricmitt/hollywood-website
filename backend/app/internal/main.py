...
def create_app(cfg: Config | None = None) -> FastAPI:
    ...
    if cfg.IS_AGENT_BUILDER_TEMPLATE:
        from fastapi import APIRouter as _APIRouter
        from .agent_builder.activity_router import router as _activity_router
        from .agent_builder.board_router import router as _board_router
        from .agent_builder.chat_router import router as _chat_router
        from .agent_builder.tools_router import router as _tools_router
        from .agent_builder.webhook_router import router as _webhook_router

        _agent_router = _APIRouter(
            prefix="/routes/_agent", dependencies=auth_dependencies
        )
        _agent_router.include_router(_chat_router)
        _agent_router.include_router(_board_router)
        _agent_router.include_router(_tools_router)
        _agent_router.include_router(_webhook_router)
        _agent_router.include_router(_activity_router)
